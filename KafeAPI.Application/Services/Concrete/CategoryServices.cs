    ...
    public class CategoryServices : ICategoryServices
    {
        ...
        public async Task<ResponseDto<object>> DeleteCategory(int id)
        {
            try
            {
                ...
                if (category == null)
                {
                    ...
                    return new ResponseDto<object> { Success = false,Data=null, Message = "Kategori Bulununamadı", ErrorCodes = ErrorCodes.NotFound };
        ...
        public async Task<ResponseDto<object>> UpdateCategory(UpdateCategoryDto dto)
        {
            ...
            {   
                ...
                if (categorydb == null)
                {
                    return new ResponseDto<object> { Success = false, Message = "Kategori Bulunamadi.", ErrorCodes = ErrorCodes.NotFound };
                }
